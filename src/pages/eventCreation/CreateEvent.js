      ...
      <App>
        ...
        <LeftSide>
            ...
            <EventFormHolder>
              ...
              <p>Event Name</p>
              <div>
               <MdDriveFileRenameOutline style={{color: '#C4C4C4',alignItems: 'center',paddingTop:'5%',paddingLeft:'1.5%'}}/> 
               <input name="name" type="id" placeholder="Type here..."/>
              </div>
              <p>Event Category</p>
              <div>
               <BiCategory style={{color: '#C4C4C4',alignItems: 'center',paddingTop:'5%',paddingLeft:'1.5%', width:'30px'}}/>
               <input name="name" type="id" placeholder="Type here..."/>
              </div>
              <p>Event Date</p>
              <div>
               <BsCalendar2Date style={{color: '#C4C4C4',alignItems: 'center',paddingTop:'5%',paddingLeft:'1.5%', width:'30px'}}/>
               <input name="name" type="id" placeholder="Type here..."/>
              </div>
              </EventSource>
              <EventCounts>
              <p>Event Theme</p>
              <div>
               <MdOutlineAssignmentTurnedIn style={{color: '#C4C4C4',alignItems: 'center',paddingTop:'5%',paddingLeft:'1.5%', width:'30px'}}/> 
               <input name="name" type="id" placeholder="Type here..."/>
              </div>
              <p>Event Location</p>
              <div>
               <VscLocation style={{color: '#C4C4C4',alignItems: 'center',paddingTop:'5%',paddingLeft:'1.5%', width:'30px'}}/>
               <input name="name" type="id" placeholder="Type here..."/>
              </div>
              <p>Event Time</p>
              <div>
               <WiTime4 style={{color: '#C4C4C4',alignItems: 'center',paddingTop:'4%',paddingLeft:'1.5%', width:'30px',height:'20px'}}/>
               <input name="name" type="id" placeholder="Type here..."/>
              </div>
              </EventCounts>
            </EventFormHolder>
