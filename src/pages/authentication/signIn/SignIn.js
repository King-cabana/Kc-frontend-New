...
import {
  Form, InputFieldWrapper, LongButton, ModalOverlay,
  Div, Horizontal, Or, SignInLink
} from '../../../globalStyles';
...
const SignIn = () => {
  ...
  const handleLogin = () => {
    ...
    dispatch(apiFetch({ apiName: 'signInUser', body: { email, password }, method: 'post', url: 'login' }))
  }
