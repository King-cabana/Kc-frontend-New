...
import {App,RightSide,LogoHolder,Image,EventManagementHolder,CreateEvent, 
  EventProposal,LeftSide, CreateEventHolder,EventHolder,ResearchCategoryHolder,
  VerticalLine,PictureHolder,EventFormHolder,EventNameHolder,AttendanceHolder,
  SponsorHolder,EventFolder,EventSource,EventListHolder,EventSourceHolder,EventCounts,
  EventDateHolder,EventTimeHolder,EventDescription,EventSponsorHolder,ContactHolder,
  SecondaryInfoHolder,InfoHolder,ListHolder,OfficeHolder,DepartmentOfficeHolder,
  DepartmentHolder,Office,EmailPhoneHolder,EmailHolder,PhoneHolder,ButtonHolder,
  NextBtn,PrevBtn,HorizontalTags,HelpTag,SettingTag,Reportmgt} from "./EventManagement.styled"
